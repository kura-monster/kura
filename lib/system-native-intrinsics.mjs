...
import { compileOwnershipIntrinsic } from './system-native-ownership-intrinsics.mjs';
...
export function compileSystemIntrinsic(emitter, expression) {
  ...
  const ownershipIntrinsic = compileOwnershipIntrinsic(emitter, expression, path);
  if (ownershipIntrinsic) return ownershipIntrinsic;
